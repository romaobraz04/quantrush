// Public settings only. Provider credentials belong in Supabase or CI secrets.
export const siteConfig = Object.freeze({
  release: 'beta-2026-09-06',
  legacyUrl: 'https://romaobraz04.github.io/quantrush/',
  productionUrl: 'https://quantrush.pages.dev/',
  feedbackUrl: 'https://docs.google.com/forms/d/e/1FAIpQLSefoHo00WgEJzz_vnK2DuCl29FL5e6RBKxcN_TCwypMC7twOQ/viewform',
